...
export const SignInPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!email || !password) {
      setErrorMsg('Please enter both email address and account password.');
      return;
    }
    ...
    <div className="min-h-screen bg-background text-on-surface flex flex-col justify-between font-body-md selection:bg-primary/20 selection:text-primary">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          {/* Left Panel: Security Architecture Details */}
          <div className="hidden lg:flex lg:col-span-5 flex-col gap-4 p-8 bg-surface-container-low border border-outline-variant/40 rounded-2xl shadow-xl">
            ...
            <div className="p-4 bg-surface-container-lowest border border-outline-variant/30 rounded-xl font-code-sm text-xs flex flex-col gap-2">
              ...
              <div className="text-on-surface-variant">
                Protocol: <span className="text-on-surface font-mono">Zero-Trust Token Signature</span>
              </div>
              <div className="text-on-surface-variant">
                Data Isolation: <span className="text-primary font-mono">Tenant Segregated</span>
              </div>
              <div className="text-on-surface-variant">
                Audit Trail: <span className="text-on-surface font-mono">Immutable Log Ledger</span>
              </div>
            </div>
            ...
            <div className="space-y-2 pt-2 border-t border-outline-variant/30 text-xs text-on-surface-variant">
              <div className="flex items-center gap-2">
                ...
                <span>Zero-knowledge client repository verification</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-primary" />
          ...
          <div className="lg:col-span-7 p-8 sm:p-10 bg-surface-container-low border border-outline-variant/40 rounded-2xl shadow-2xl">
            <div className="flex items-center justify-between pb-3 mb-6 border-b border-outline-variant/30">
              <span className="font-code-sm text-[11px] text-outline uppercase tracking-wider">
                SUPPLYGUARD ACCESS PROTOCOL
              </span>
              <span className="font-code-sm text-[11px] text-primary font-mono">SEC-AUTH-01</span>
            </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative flex items-center bg-surface-container-lowest border border-outline-variant/50 rounded-lg px-3 py-2.5 focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-all">
                  ...
                  <button
                    ...
                    className="text-outline hover:text-on-surface text-sm ml-2"
